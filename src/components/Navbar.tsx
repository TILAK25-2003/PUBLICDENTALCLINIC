...
export const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-gradient-to-r from-primary to-accentLight shadow-xl py-2' : 'bg-transparent py-4'}`}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-primary/95 border-t border-accent/20 overflow-hidden"
          >
