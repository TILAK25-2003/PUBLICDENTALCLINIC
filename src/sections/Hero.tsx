  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-block px-4 py-1 bg-cta/20 border border-cta/40 backdrop-blur-sm rounded-full text-white text-sm font-medium mb-6">
            Trusted by 5000+ Patients
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6 font-serif">
            World-Class Dental Care in <span className="text-cta">Muzaffarpur</span>
          </h1>
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-accentLight to-transparent z-10"></div>
    </section>
  );
};
