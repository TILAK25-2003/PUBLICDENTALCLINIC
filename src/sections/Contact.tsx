    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4 font-serif">Visit <span className="text-accent">Us</span></h2>
          <div className="w-20 h-1 bg-accent mx-auto rounded-full"></div>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Clinic 1 */}
          <div className="rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl border border-gray-200 transition-shadow duration-300">
            ...
            <div className="p-6 bg-white border-t border-gray-200">
              <div className="flex items-start gap-3 mb-6">
                <MapPin className="text-accent shrink-0 flex-shrink-0" size={20} />
                <p className="text-gray-700 leading-relaxed">Khadi bhandar, Khadi gramodyog market complex, chowk, Kanhauli, Muzaffarpur, Bihar 842002</p>
              </div>
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl border border-gray-200 transition-shadow duration-300">
            ...
            <div className="p-6 bg-white border-t border-gray-200">
              <div className="flex items-start gap-3 mb-6">
                <MapPin className="text-accent shrink-0 flex-shrink-0" size={20} />
                <p className="text-gray-700 leading-relaxed">Jalan Aushadhalay, Saraiyaganj tower, Near chunnilal megamart, Muzaffarpur, Bihar 842001</p>
              </div>
